...
import { addBalanceToUser } from '../../api';
...
function AddBalance() {
    ...
    const handleAddBalance = async () => {
        try {
            ...
            const result = await addBalanceToUser(formData);
            // console.log(result);
            setModalOpen(true);
        } catch (error) {
            console.error('Error during add balance to user:', error.message);
        }
    };
    return (
        <div>
            <body id="page-top">
                        ...
                        <div id="content">
                            ...
                            <div className="container-fluid">
                                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 className="h3 mb-0 text-gray-800">Add Balance To User</h1>
                                </div>
                                <div className="row">
                ...
                >
                    <h2>Balance Added successful!</h2>
